/*
#!name = M3u8地址获取Pro版本
#!desc = 详细使用教程看Arg说明,详细说明js内查看
#!tag = fishdown
#!icon = https://raw.githubusercontent.com/fishdown/Icon/master/app/m3u8.png


[Argument]
notify  = switch,true,tag=Loon通知+点通知跳转,desc=和vid属性相关
webhook  = switch,false,tag=方式：播放器 or 推送Webhook,desc=开启用webhook推送
webhookUrl = input, "", tag=webhookUrl, desc=webhookUrl地址从 https://webhook.site 获取
...
[Script]
http-request /\.(m3u8|mp4|flv)/i script-path=http-18-m3u8.js,requires-body=false,img-url=https://raw.githubusercontent.com/fishdown/Icon/master/app/m3u8.png,enable={sw},tag=抓取m3u8,argument=[{notify},{webhook},{webhookUrl},{vid},{userscheme},{ucode},{SkipKeywords}]
